        ...
        <div class="px-4 px-lg-0">
            <div class="pb-5">
                <div class="container">
                                ...
                                <tbody>
                                    @foreach (Cart::content() as $product)
                                        <tr>
                                            ...
                                            <td class="border-0 align-middle">
                                                <form action="{{route('cart.destoy', $product->rowId)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="col-lg-6">
                        <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Détaol de la commande</div>
                        <div class="p-4">
